...
<li>:heavy_check_mark:<strong><a href="https://github.com/TravisLeeRichardson/monday-clone">Monday Clone</a></strong>: A Monday.com CRM clone built with React, Node and Astra db.</li>  
