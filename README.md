...
<li>:heavy_check_mark:<strong><a href="https://github.com/TravisLeeRichardson/todo-app">TODO APP</a></strong>: An simple "to do" app built with React, Node and PostgreSQL with encrypted authentication.</li>
  </ul>
