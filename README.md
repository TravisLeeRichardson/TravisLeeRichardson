...
<li>:heavy_check_mark:<strong><a href="https://github.com/TravisLeeRichardson/todo-app">TODO APP</a></strong>: A simple "to do" app built with React, Node and PostgreSQL with encrypted authentication and deployed on Kinsta.</li>
  </ul>
